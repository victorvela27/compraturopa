...
<section class="hero-area bg-primary" id="parallax">
  ...
  <ul class="list-unstyled ml-5 mt-3 position-relative zindex-1">
    <li class="mb-3"><a class="text-white" href="https://facebook.com/leo.arredondo.39"><i class="ti-facebook"></i></a></li>
    <li class="mb-3"><a class="text-white" href="https://instagram.com/katiilo_3?igshid=YmMyMTA2M2Y="><i class="ti-instagram"></i></a></li>
 
    <li class="mb-3"><a class="text-white" href="https://twitter.com/VictorV57467147"><i class="ti-twitter"></i></a></li>
  </ul>
  <!-- /social icon -->
</section>
<!-- /hero area -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2 class="section-title">Categorias más compradas</h2>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          ...
          <div class="card-footer bg-white">
            <h4 class="card-title">Caballeros (80%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          ...
          <div class="card-footer bg-white">
            <h4 class="card-title">Damas (70%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          <div class="position-relative rounded-top progress-wrapper" data-color="#bdecf6">
            <div class="wave" data-progress="30%"></div>
          </div>
          <div class="card-footer bg-white">
            <h4 class="card-title">Niños (30%)</h4>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
        <div class="card shadow text-center">
          <div class="position-relative rounded-top progress-wrapper" data-color="#ffbcaa">
            <div class="wave" data-progress="20%"></div>
          </div>
          <div class="card-footer bg-white">
            <h4 class="card-title">Deportivas (20%)</h4>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-around">
      ...
      <div class="col-lg-3 col-md-4 text-center">
        ...
        <p class="mb-0">Enero 2021 - Feb 2021</p>
        <h4>Pagina más consultada en un Mes</h4>
        <h6 class="text-light">WEBEX</h6>
      </div>
      <div class="col-lg-3 col-md-4 text-center">
        <img src="images/experience/icon-2.png" alt="icon">
        <p class="mb-0">Enero 2021 - Diciembre 2021</p>
        <h4>Mejor página de compras del año</h4>
        <h6 class="text-light">AUGMEDIX</h6>
      </div>
      <div class="col-lg-3 col-md-4 text-center">
        <img src="images/experience/icon-3.png" alt="icon">
        <p class="mb-0">Enero 2021 - Present</p>
        <h4>Página con record de visitas</h4>
        <h6 class="text-light">Google</h6>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 mb-80">
        <div class="d-flex">
          ...
          <div>
            ...
            <h4>5 Estrellas para la pagina</h4>
      ...
      <div class="col-lg-6 col-md-6 mb-80">
        <div class="d-flex">
          ...
          <div>
            <p class="text-dark mb-1">2021</p>
            <h4>Honores a mejor pagina de compras</h4>
